...
class Case(models.Model):
    ...
    assigned_official = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='assigned_cases')
    ...
    parties_involved = models.JSONField(null=True, blank=True)
